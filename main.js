...
function resetExercise(num) {
    ...
    switch(num) {
        case 1:
            // Ex1 - text inputs (audio drill — auzi numarul scrie cifra)
        ...
        case 2:
            ...
            break;
        case 3:
            // Ex3 - text inputs (conjugare sein)
            ex3Data.forEach(item => {
                const el = document.getElementById(`ex3-${item.id}`);
        ...
        case 4:
            ...
            break;
        case 5:
            // Ex5 - text inputs (raspunde la intrebari personale)
